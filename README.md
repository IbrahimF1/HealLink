...
| 💬 **AI Introduction**| ![Ollama](https://img.shields.io/badge/Ollama-Gemma3n-lightgrey)                 | Google's `gemma3n:e2b` model is served locally via Ollama to generate warm, personalized introductions between a matched mentor and mentee, helping to break the ice.               |
